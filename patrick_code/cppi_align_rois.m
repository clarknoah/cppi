...
input_roi_dir = '/Volumes/coax_lab/patrick_project/subjects/subjects/%s_1/perm_test';
output_roi_dir = '/Volumes/coax_lab/patrick_project/subjects/subjects/s_1/rois';
hemis = {'lh', 'rh'};

for sub = subs;
    disp(char(sub));
    in_roi_dir = sprintf('/Volumes/coax_lab/patrick_project/subjects/subjects/%s_1/perm_test',char(sub));   
    out_roi_dir = sprintf('/Volumes/coax_lab/patrick_project/subjects/subjects/%s_1/rois',char(sub));
