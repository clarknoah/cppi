        ...
        if(strcmp(file.function,'roi')&& file.hemi==true)
            ...
            for y=1:length(fields)
                ...
                if(strcmp(o_file.function,'roi')&& o_file.hemi==true ...
                    ...
                    intersectfn =  cppi.parse_session_path('%s/%s%s/rois/lhBA1234.nii', subject,session);
                    cppi_align_rm_overlap( ...
                     ...
                     intersectfn =  cppi.parse_session_path('%s/%s%s/rois/rhBA1234.nii', subject,session);
                    cppi_align_rm_overlap( ...
