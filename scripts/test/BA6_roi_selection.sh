      ...
      do
        ...
        for roi in rh lh
          do
            ...
            mri_label2vol --label $FREESURFER_SUBJECT_ROOT/${subject}/label/${roi}.BA3a.thresh.label --subject ${subject} --hemi ${roi} --identity --temp $FREESURFER_SUBJECT_ROOT/${subject}/mri/T1.mgz --o $SUBS_ROOT/${subject}${session}/perm_test/${roi}BA3.nii --proj frac 0 1 0.1
