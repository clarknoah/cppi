...
for session in _1 _2
  ...
  for roi in rh lh
  do
    mri_label2vol --label $FREESURFER_SUBJECT_ROOT${subject}/label/${roi}.BA6.thresh.label --subject ${subject} --hemi ${roi} --identity --temp $FREESURFER_SUBJECT_ROOT${subject}/mri/T1.mgz --o $SUBS_ROOT${subject}_2/perm_test/${roi}BA6.nii --proj frac 0 1 0.1

    mri_label2vol --label $FREESURFER_SUBJECT_ROOT${subject}/label/${roi}.BA4p.thresh.label --label $FREESURFER_SUBJECT_ROOT${subject}/label/${roi}.BA4a.thresh.label --subject ${subject} --hemi ${roi} --identity --temp $FREESURFER_SUBJECT_ROOT${subject}/mri/T1.mgz --o $SUBS_ROOT${subject}_2/perm_test/${roi}BA4.nii --proj frac 0 1 0.1

    mri_label2vol --label $FREESURFER_SUBJECT_ROOT${subject}/label/${roi}.BA3a.thresh.label --label $FREESURFER_SUBJECT_ROOT${subject}/label/${roi}.BA3b.thresh.label --label $FREESURFER_SUBJECT_ROOT${subject}/label/${roi}.BA1.thresh.label --label $FREESURFER_SUBJECT_ROOT${subject}/label/${roi}.BA2.thresh.label --subject ${subject} --hemi ${roi} --identity --temp $FREESURFER_SUBJECT_ROOT${subject}/mri/T1.mgz --o $SUBS_ROOT${subject}_2/perm_test/${roi}BA123.nii --proj frac 0 1 0.1
